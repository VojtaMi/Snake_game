...
class SnakeBody:
    ...
    def _draw_snake(self, screen):
        ...
        while from_segment is not self.head:
            draw_body_turtle.setheading(from_segment.get_heading())
        ...
        for i in range(steps):
            ...
            draw_ht_turtle.setheading(self.tail.get_heading())
            ...
            draw_ht_turtle.pendown()
            draw_ht_turtle.setheading(self.head.get_heading())
    ...
    def _pass_directions(self):
        ...
        while earlier_segment:
            later_segment.set_heading(earlier_segment.get_heading())
